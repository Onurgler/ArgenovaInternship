            ...
            <div class="collapse navbar-collapse" id="navbarsExample">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <div class="dropdown-hover-all">
                            <div class="dropdown " style="width: 70px; margin-right: 30px;">
                                <a class="nav-link dene" href="/Task14/index.php" id="dropdownMenuButtonHome" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home
                                </a>
                    ...
                    <li class="nav-item" style="width: 60px; margin-right: 30px;">
                        <a class="nav-link" href="/Task14/index.php">About</a>
                    </li>
                    <li class="nav-item">
                        <div class="dropdown-hover-all">
                            <div class="dropdown " style="width: 90px; margin-right: 30px;">
                                <a class="nav-link dene" href="/Task14/index.php" id="dropdownMenuButtonHomeS" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services
                                </a>
                    ...
                    <li class="nav-item">
                        <div class="dropdown-hover-all">
                            <div class="dropdown " style="width: 70px; margin-right: 30px;">
                                <a class="nav-link dene" href="/Task14/index.php" id="dropdownMenuButtonPage" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages
                                </a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonPage">
                                    ...
                                    <div class="dropdown dropstart">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdown-layouts">
                                            ...
                                            <a class="dropdown-item" href="/Task14/login.php">My Account</a>
                                        </div>
                                    </div>
                    ...
                    <li class="nav-item">
                        <div class="dropdown-hover-all">
                            <div class="dropdown " style="width: 70px; margin-right: 30px;">
                                <a class="nav-link dene" href="/Task14/index.php" id="dropdownMenuButtonBlog" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog
                                </a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonBlog">
                                    <a class="dropdown-item" href="/Task14/blog.php">Blog</a>
                                    <a class="dropdown-item" href="/Task14/blog-details.php">Blog Details</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/Task14/index.php">Contact</a>
                    </li>
                </ul>
            </div>

    ...
    <div class="breadcrumbs-inner text-center">
        ...
        <ul class="list-inline">
            <li style="display: inline-block;">
                <a class="active" style="color: white;" href="/Task18/index.php">Home</a>
            </li>
    ...
    text-align: left; ">
                                    ...
                                    <div class="row mx-auto">
                                        <div class="mb-4">
                                            ...
                                            <input class="form-control bg-light formStyle" type="text" id="seotitle" name="seotitle">
                                        </div>
                                    </div>
                                    <div class="row mx-auto">
                                        <div class="mb-4">
                                            <label class="mb-2 " style="font-weight: 600">Seo Description<span>* </span></label>
                                            <input class="form-control bg-light formStyle" type="text" id="seodesc" name="seodesc">
                                        </div>
                                    </div>
                                    <div class="row mx-auto">
                                        <div class="mb-4">
                                            <label class="mb-2 " style="font-weight: 600">Seo Keywords<span>* </span></label>
                                            <input class="form-control bg-light formStyle" type="text" id="seokey" name="seokey">
                                        </div>
                                    </div>

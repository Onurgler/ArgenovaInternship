            ...
            <div class="collapse navbar-collapse" id="navbarsExample">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <div class="dropdown-hover-all">
                            <div class="dropdown " style="width: 70px; margin-right: 30px;">
                                <a class="nav-link dene" href="index.php" id="dropdownMenuButtonHome" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home
                                </a>
                    ...
                    <li class="nav-item">
                        <div class="dropdown-hover-all">
                            <div class="dropdown " style="width: 90px; margin-right: 30px;">
                                <a class="nav-link dene" href="index.php" id="dropdownMenuButtonHomeS" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services
                                </a>
                    ...
                    <li class="nav-item">
                        <div class="dropdown-hover-all">
                            <div class="dropdown " style="width: 70px; margin-right: 30px;">
                                <a class="nav-link dene" href="index.php" id="dropdownMenuButtonPage" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages
                                </a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonPage">
                                    ...
                                    <div class="dropdown dropstart">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdown-layouts">
                                            ...
                                            <a class="dropdown-item" href="login.php">My Account</a>
                                        </div>
                                    </div>
                    ...
                    <li class="nav-item">
                        <div class="dropdown-hover-all">
                            <div class="dropdown " style="width: 70px; margin-right: 30px;">
                                <a class="nav-link dene" href="index.php" id="dropdownMenuButtonBlog" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog
                                </a>
